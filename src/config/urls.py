...
from accounts.views import UserActivationView, UserLogin, UserLogout, UserRegistration, generate_accounts_view
from common.views import IndexView
from games.views import generate_games_view, generate_reviews_view, generate_wishlist_view
